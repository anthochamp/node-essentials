...
describe("TcpServer", () => {
	...
	describe("close", () => {
		...
		it("should allow closing after all connections are closed", async () => {
			...
			await client.connect(serverPort, { host: serverHost });
	...
	describe("getConnections", () => {
		...
		it("should return the correct connection count", async () => {
			...
			await client1.connect(serverPort, { host: serverHost });
			...
			await client2.connect(serverPort, { host: serverHost });
	...
	describe("integration scenarios", () => {
		...
		it("should handle multiple concurrent connections", async () => {
			...
			await client3.connect(serverPort, { host: serverHost });
	...
	describe("events", () => {
		...
		it("should emit drop event with endpoint information", async () => {
			...
			const client = TcpSocket.from();
			client.connect(serverPort, { host: serverHost }).catch(() => {
