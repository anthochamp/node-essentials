...
/**
 * Difference of two `bitWidth`-bit two's-complement integers, under `mode`.
 *
 ...
 * @throws {OverflowError} When the difference does not fit and `mode` is
 *   `abort`.
 */
export function fixedSIntBigSub(
	left: bigint,
	right: bigint,
	bitWidth: number,
	mode?: OverflowMode,
