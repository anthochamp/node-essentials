import { round, type RoundingMethod } from "../number/round.js";
...
export function toFixedLength(
	...
	let maxFractionDigits = options?.maxFractionDigits ?? 0;
	let fixedFractionDigits = options?.fixedFractionDigits ?? false;
	let roundingMethod = options?.roundingMethod ?? "round";
