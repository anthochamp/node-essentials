import { isAggregateErrorLike } from "../guards/is-aggregate-error.js";
import { isErrorLike } from "../guards/is-error.js";
import { isSuppressedErrorLike } from "../guards/is-suppressed-error.js";
...
export function traverseError(
	...
	const effectiveOptions = defaults<Required<TraverseErrorOptions>>(options, {
		traverseCause: true,
