...
import { JsonReplacer, JsonReviver, JsonStringifyResult } from "../json.js";
...
declare global {
	...
	interface JSON {
		 ...
		 * and space argument.
		 *
		 * Returns `undefined` if the value cannot be stringified (e.g.,
		 * `undefined`, function, or symbol at the root level).
		 *
		 * @remarks
