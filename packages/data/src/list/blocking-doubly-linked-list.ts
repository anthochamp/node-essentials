...
export type BlockingDoublyLinkedListOptions<T extends DefinedValue> =
	BoundedOptions<DoublyLinkedList<T>>;

/**
 * A {@link DoublyLinkedList} that holds at most `capacity` items, and whose
 ...
 */
export class BlockingDoublyLinkedList<T extends DefinedValue>
	implements
		IList<T>,
		IBounded,
		IPushBackStorage<T>,
		...
		IBidirectionalCursorSequence<T, DoublyLinkedListCursor<T>>
{
	...
	constructor(
		...
		options: BlockingDoublyLinkedListOptions<T>,
	) {
