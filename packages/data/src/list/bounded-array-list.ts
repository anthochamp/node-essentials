...
export type BoundedArrayListOptions<T extends DefinedValue> = BoundedOptions<
	ArrayList<T>
>;

/**
 * An {@link ArrayList} that holds at most `capacity` items and throws once full.
 *
 * @template T The type of elements in the list.
 */
export class BoundedArrayList<T extends DefinedValue>
	implements
		IList<T>,
		IBounded,
		IPushBackStorage<T>,
		...
		IBidirectionalCursorSequence<T, IRandomAccessCursor<T>>
{
	...
	constructor(
		...
		options: BoundedArrayListOptions<T>,
	) {
