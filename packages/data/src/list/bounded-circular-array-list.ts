...
export type BoundedCircularArrayListOptions<T extends DefinedValue> =
	BoundedOptions<CircularArrayList<T>>;

/**
 * A {@link CircularArrayList} that holds at most `capacity` items and throws
 * once full.
 *
 * @template T The type of elements in the list.
 */
export class BoundedCircularArrayList<T extends DefinedValue>
	implements
		IList<T>,
		IBounded,
		IPushBackStorage<T>,
		...
		IBidirectionalCursorSequence<T, IRandomAccessCursor<T>>
{
	...
	constructor(
		...
		options: BoundedCircularArrayListOptions<T>,
	) {
