...
export type BlockingCircularArrayListOptions<T extends DefinedValue> =
	BoundedOptions<CircularArrayList<T>>;

/**
 * A {@link CircularArrayList} that holds at most `capacity` items, and whose
 ...
 */
export class BlockingCircularArrayList<T extends DefinedValue>
	implements
		IList<T>,
		IBounded,
		IPushBackStorage<T>,
