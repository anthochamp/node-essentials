...
export interface IDeque<T = unknown> extends ICollection<T> {
	 ...
	 *
	 * The items are added in the order they are provided, with the last item in
	 * the argument list becoming the new front of the deque.
	 *
	 ...
	 *
	 * The items are added in the order they are provided, with the last item in
	 * the argument list becoming the new back of the deque.
	 *
