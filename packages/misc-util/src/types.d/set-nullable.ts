...
/**
 * Utility type that makes the specified keys of an object type nullable (i.e.,
 ...
 * ```
 *
 * If no keys are specified, all properties of the object type will be made
 * nullable.
 *
 * Example:
 *
 ...
 * @template Keys The keys of the object type to make nullable. Defaults to all
 *   keys of the object type.
 */
