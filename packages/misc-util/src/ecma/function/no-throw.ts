 ...
 *
 * This prevents unhandled exceptions from disrupting the current execution
 * flow.
 *
 ...
 *
 * @param func The function to wrap.
 * @returns A new async function that wraps the original function and catches
 *   any errors thrown or promise rejections.
 */
