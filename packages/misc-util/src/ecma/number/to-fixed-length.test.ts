...
describe("toFixedLength", () => {
	it("should format numbers correctly with fixedFractionDigits=true", () => {
		expect(
	...
	it("should format numbers correctly with fixedFractionDigits=false", () => {
	...
	it("should format numbers correctly with fixedLength=5, fractionDigits=3, fixedFractionDigits=false", () => {
	...
	it("should format numbers correctly with fixedLength=6, fractionDigits=2, fixedFractionDigits=false", () => {
