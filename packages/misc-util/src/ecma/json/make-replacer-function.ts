 ...
 *
 * The resulting function applies the base replacer first, then the user
 * replacer if provided, and finally filters properties based on the property
 * list if provided.
 *
 * @param baseReplacerFunction The base replacer function to apply first.
 * @param userReplacer An optional user-defined replacer (function or property
 *   list).
